...
namespace QuanLyBongDa
{
    public partial class ChiTietKetQua : Form
    {
        ...
        {
            var dsctkq = from u in qlbd.CHITIETKETQUAs select new { STT = u.STT, TenCT = u.CAUTHU.TenCT, TenDB = u.DOIBONG.TenDB, LoaiBT = u.LoaiBT, ThoiDiem = u.ThoiDiem, MaKQ = u.MaKQ };
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            CHITIETKETQUA CTKQ = qlbd.CHITIETKETQUAs.Where(ctkq => ctkq.STT == stt).SingleOrDefault();
            if(CTKQ != null)
            {
